...
from wavefunction_tools import radial_axis, wavefunction_slice_cartesian, complex_phase
...
def main() -> None:
    ...
    ax1.set_title(r"$|\psi_{%s,%s,%s}|$ on %s-plane" % (n, l, m, plane))
